...
// Copyright (C) 2022-2023, Dave Brennan, Qbit Devs
//
...
class Config {
    constructor() {
        /**
         * The amount of decimal places your coin has, e.g. Qbit has five
         * decimals
         */
        this.decimalPlaces = 5;
        /**
         * The address prefix your coin uses - you can find this in CryptoNoteConfig.h.
         * In Qbit.money, this converts to QBC
         */
        this.addressPrefix = 0x478a;
        /**
        ...
        /**
         * Your coins 'ticker', generally used to refer to the coin, i.e. 123 QBC
         */
        this.ticker = 'QBC';
        /**
         ...
         * above. This value comes out to 1. We use this value instead of
         * something like 2 because it makes for pretty resulting fees
         * - 10 bit. You can read this as.. the fee per chunk
         * is 00 atomic units. The fee per byte is 00 / chunk size. */
        this.minimumFeePerByte = 0.10 / this.feePerByteChunkSize;
        /**
